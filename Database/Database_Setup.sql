...
-- Recreating the retirement info table to include employee_no.
...
-- Check the new retirement info table.
SELECT * FROM retirement_info;

-- Practicing joining tables. Joining departments and dept_manager tables and creating aliases of table names.
SELECT d.dept_name,
     dm.emp_no,
     dm.from_date,
     dm.to_date
...
-- Joining retirement_info and dept_emp tables; creating aliases of table names; creating new current_emp table.
SELECT ri.emp_no,
    ri.first_name,
	ri.last_name,
    de.to_date
...
-- Check the new current_emp table.
SELECT * FROM current_emp;

-- Employee count by department number and putting that into a new table retirement_count_bydept.
